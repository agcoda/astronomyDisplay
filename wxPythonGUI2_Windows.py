...
#		self.imageFile = 
		...
		#MY home PC directory
#		self.imageFile = ["D:/Documents_2/Repos/AstronomyDisplay/Images/Attendance.jpg", \
#					"D:/Documents_2/Repos/AstronomyDisplay/Images/EclipseImage.jpg",\
#					"D:/Documents_2/Repos/AstronomyDisplay/Images/LookingUp.jpg",\
#					"D:/Documents_2/Repos/AstronomyDisplay/Images/StudentView.jpg"\
#					]


		self.numImages = len(self.imageFile)

		img = wx.EmptyImage(self.screenWidth,self.screenHeight)
