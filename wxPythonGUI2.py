...
class textPanel(wx.Panel):
	def __init__(self, parent):
		...
		wx.Panel.__init__(self, parent=parent, size = (self.screenWidth,self.screenHeight))

		self.SetBackgroundColour((0,0,0))
		self.messageLine1 = "Astronomy Night!"
		self.nextDate = "Weds January 29th"
		self.nextTime = "7:30pm"
		self.nextLocation = "Engineering Lawn"
...
#		self.imageFile =  ["./Images/FreddieMercury.jpg", \
#					"./Images/FreddieMercury.jpg",\
#					"./Images/FreddieMercury.jpg",\
#					"./Images/FreddieMercury.jpg"\
#					]
...
#pi files
		self.imageFile = ["./Images/Attendance.jpg", \
					"./Images/EclipseImage.jpg",\
					"./Images/LookingUp.jpg",\
					"./Images/StudentView.jpg"\
					]

		self.numImages = len(self.imageFile)

		img = wx.EmptyImage(self.screenWidth/2,self.screenHeight)
		self.imageCtrl = wx.StaticBitmap(self, wx.ID_ANY, wx.BitmapFromImage(img))

#		imgDisplay = imgDisplay.Scale(self.screenWidth/2,self.screenHeight)
...
#C:\Users\agcod\Documents\MethodSystemsRepo\AstronomyDisplay\Images\Attendance.jpg
	...
	def createImageWidgets(self):
		...
		imgDisplay = wx.Image(self.imageFile[self.imgToShow],wx.BITMAP_TYPE_ANY)
		imgDisplay = imgDisplay.Scale(self.screenWidth,self.screenHeight)
...
#when switching back to text panel do not change the image, but reset the counter to restart the loop
	...
	def startShow(self):
		...
		self.timerImages.Start(self.msPerImage)
